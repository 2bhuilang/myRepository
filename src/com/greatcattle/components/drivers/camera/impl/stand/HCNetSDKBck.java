...
public interface HCNetSDKBck extends StdCallLibrary {
 
	HCNetSDKBck INSTANCE = (HCNetSDKBck) Native.loadLibrary("E:\\e\\rb\\dev64lib\\HCNetSDK.dll", HCNetSDKBck.class);
...
//IPC接入参数配置
	...
	public class NET_DVR_IPDEVINFO_V31 extends Structure {
		...
		public byte[] sUserName = new byte[HCNetSDKBck.NAME_LEN];// 用户名
		public byte[] sPassword = new byte[HCNetSDKBck.PASSWD_LEN];// 密码
		public byte[] byDomain = new byte[HCNetSDKBck.MAX_DOMAIN_NAME];// 设备域名
		...
		protected List<?> getFieldOrder() {
			return Arrays.asList("byEnable", "byProType", "byEnableQuickAdd", "byRes1", "sUserName", "sPassword",
					"byDomain", "struIP", "wDVRPort", "szDeviceID", "byRes2");
		}

		public static class ByReference extends NET_DVR_IPDEVINFO_V31 implements Structure.ByReference {

		};

		public static class ByValue extends NET_DVR_IPDEVINFO_V31 implements Structure.ByValue {
	...
	public class NET_DVR_IPSERVER_STREAM extends Structure {
		...
		public byte[] byDVRName = new byte[HCNetSDKBck.NAME_LEN];
		public short wDVRSerialLen;
		public short[] byRes1 = new short[2];
		public byte[] byDVRSerialNumber = new byte[HCNetSDKBck.SERIALNO_LEN];
		public byte[] byUserName = new byte[HCNetSDKBck.NAME_LEN];
		public byte[] byPassWord = new byte[HCNetSDKBck.PASSWD_LEN];
	...
	public class NET_DVR_DEV_CHAN_INFO extends Structure {
		...
		public byte[] byDomain = new byte[HCNetSDKBck.MAX_DOMAIN_NAME];// 设备域名
		public byte[] sUserName = new byte[HCNetSDKBck.NAME_LEN];// 设备登陆帐号
		public byte[] sPassword = new byte[HCNetSDKBck.PASSWD_LEN];// 设备密码
	}
	...
	public class NET_DVR_DDNS_STREAM_CFG extends Structure {
		...
		public byte[] sDVRName = new byte[HCNetSDKBck.NAME_LEN];
		public short wDVRNameLen;
		public short wDVRSerialLen;
		public byte[] sDVRSerialNumber = new byte[HCNetSDKBck.SERIALNO_LEN];
		public byte[] sUserName = new byte[HCNetSDKBck.NAME_LEN];
		public byte[] sPassWord = new byte[HCNetSDKBck.PASSWD_LEN];
		public short wDVRPort;
	...
	public class NET_DVR_HKDDNS_STREAM extends Structure {
		...
		public byte[] byAlias = new byte[HCNetSDKBck.NAME_LEN];// 别名
		public short wDVRSerialLen;// 序列号长度
		public byte[] byRes1 = new byte[2];// 保留
		public byte[] byDVRSerialNumber = new byte[HCNetSDKBck.SERIALNO_LEN];// 设备序列号
		public byte[] byUserName = new byte[HCNetSDKBck.NAME_LEN];// 设备登录用户名
		public byte[] byPassWord = new byte[HCNetSDKBck.PASSWD_LEN];// 设备登录密码
		public byte byChannel;// 设备通道号
...
//用于接收报警信息的缓存区
	...
	public static interface FMSGCallBack extends StdCallCallback {
		public void invoke(NativeLong lCommand, NET_DVR_ALARMER pAlarmer, HCNetSDKBck.RECV_ALARM pAlarmInfo, int dwBufLen,
				Pointer pUser);
	}
...
/*
 * interface GDI32 extends W32API { GDI32 INSTANCE = (GDI32)
 ...
 * DEFAULT_OPTIONS);
 * 
 * public static final int BF_LEFT = 0x0001; public static final int BF_TOP =
 * 0x0002; public static final int BF_RIGHT = 0x0004; public static final int
 * BF_BOTTOM = 0x0008; public static final int BDR_SUNKENOUTER = 0x0002; public
